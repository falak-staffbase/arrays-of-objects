...
import { ObjectArraysProps, ObjectArrays } from "./object-arrays";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <object-arrays message="world!"></object-arrays>
   */
  return class ObjectArraysBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): ObjectArraysProps {
      const attrs = this.parseAttributes<ObjectArraysProps>();
      return {
        ...attrs
      };
    }
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<ObjectArrays {...this.props} />, container);
    }
